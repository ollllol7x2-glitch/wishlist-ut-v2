...
window.UT_TASKS = {
  t1: {
    ...
    prompt: '전에 찜해 둔 메리어라운드의 파란색 브이넥 니트를 다시 보고 싶습니다. 해당 상품을 찾아 현재 가격을 확인해 주세요.',
    highlight: '메리어라운드의 파란색 브이넥 니트',
    ...
    conditions: {
      ...
      after: {
        ...
        targetId: 'p16',
        targetName: '메리어라운드 파란색 브이넥 니트',
        screens: ['C1 홈의 디어먼트 브이넥 니트 가디건 기준 상품', '카테고리·스타일 맥락이 유사한 연관 찜 상품', '대상 상품 상세']
      }
    }
  },
  t2: {
